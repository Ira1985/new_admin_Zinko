...
const BASE_API_URL = '/roles/';
const consts = [i18n.t('services.roles.obj'), i18n.t('services.roles.objecta'),
    i18n.t('services.roles.objectov'), i18n.t('services.roles.objects')];
...
function getList(filters, sorter, paging) {
    return baseService.getList(BASE_API_URL, filters, sorter, paging, consts)
        .then(res => {
            ...
            console.log('Something wrong in role service getList', error);
            return null;
        });
}
...
function getItem(id) {
    return baseService.getItem(BASE_API_URL, id, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service getItem', error);
            return null;
        });
}
...
function remove(id) {
    return baseService.remove(BASE_API_URL, id, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service remove', error);
            return null;
        });
}
...
function removeByList(ids) {
    return baseService.removeByList(BASE_API_URL, ids, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service removeByList', error);
            return null;
        });
}
...
function removeByFilter(filters) {
    return baseService.removeByList(BASE_API_URL, filters, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service removeByFilter', error);
            return null;
        });
}
...
function saveItem(item) {
    return baseService.saveItem(BASE_API_URL, item, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service saveItem', error);
            return null;
        });
}
...
function update(item) {
    return baseService.update(BASE_API_URL, item, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service update', error);
            return null;
        });
}
...
function create(item) {
    return baseService.create(BASE_API_URL, item, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service create', error);
            return null;
        });
}
...
function getCombo(name, limit) {
    return baseService.getCombo(BASE_API_URL, name, limit, consts)
        ...
        .catch(error => {
            console.log('Something wrong in role service getCombo', error);
            return null;
        });
}
...
function dump(filters) {
    return baseService.dump(BASE_API_URL, filters, consts)
        .then(res => {
            ...
            console.log('Something wrong in role service dump', error);
            return null;
        });
}