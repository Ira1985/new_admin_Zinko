            ...
            <div className='navigation-base-menu'>
                ...
                <div className='menu-items-block'>
                    <div className='menu-item'>
                        ...
                        <p className='menu-item-name'>Сообщения</p>
                    </div>
                    <div className='menu-item'>
                        ...
                        <p className='menu-item-name'>Меню</p>
                    </div>
                    <div className='menu-item'>
                        ...
                        <p className='menu-item-name'>Товары</p>
                    </div>
                    <div className='menu-item'>
                        ...
                        <p className='menu-item-name'>Настройки</p>
                    </div>
                    <div className='menu-item'>
                        ...
                        <p className='menu-item-name'>Помощь</p>
                    </div>
                </div>
            </div>
            </>
...
export default NavigationBaseMenu;